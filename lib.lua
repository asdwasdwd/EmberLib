...
-- Color scheme (match WeaponDuper)
...
function Window:CreateTextBox(config)
	...
	-- Handle pre-set text or placeholder
	...
	textBox.FocusLost:Connect(function(enterPressed)
		...
		-- Update placeholder to "Name: value" and clear text
...
function Ember:CreateWindow(config)
	...
	-- Create Main Frame (WeaponDuper style)
	...
	-- Create Header (WeaponDuper style)
	...
	-- Create Exit Button (WeaponDuper style: small square, double-click to close)
	...
	-- Exit button logic (WeaponDuper style)
	...
	-- Create Button Container (WeaponDuper style)
